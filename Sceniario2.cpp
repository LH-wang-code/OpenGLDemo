...
void renderWall()
{
	if (wallVAO == 0)
	{
		...
		const int facesRender = 5;
		const int facesVertices = 6;
		GLfloat Vertices[facesRender * facesVertices * 14];
		int vertexIndex = 0;
		for (int i = 0;i < facesRender;i++)
		{
			glm::vec3 tangent1, bitangent1;
			glm::vec3 tangent2, bitangent2;

			glm::vec3 edge1 = position[i][1] - position[i][0];
			glm::vec3 edge2 = position[i][2] - position[i][0];
			...
			edge1 = position[i][2] - position[i][0];
			edge2 = position[i][3] - position[i][0];
			deltaUV1 = uv3 - uv1;
			deltaUV2 = uv4 - uv1;
			...
			// 顶点1
			Vertices[vertexIndex++] = position[i][0].x;
			Vertices[vertexIndex++] = position[i][0].y;
			Vertices[vertexIndex++] = position[i][0].z;
			Vertices[vertexIndex++] = normals[i].x;
			Vertices[vertexIndex++] = normals[i].y;
			Vertices[vertexIndex++] = normals[i].z;
			Vertices[vertexIndex++] = uv1.x;
			Vertices[vertexIndex++] = uv1.y;
			Vertices[vertexIndex++] = tangent1.x;
			Vertices[vertexIndex++] = tangent1.y;
			Vertices[vertexIndex++] = tangent1.z;
			Vertices[vertexIndex++] = bitangent1.x;
			Vertices[vertexIndex++] = bitangent1.y;
			Vertices[vertexIndex++] = bitangent1.z;

			// 顶点2
			Vertices[vertexIndex++] = position[i][1].x;
			Vertices[vertexIndex++] = position[i][1].y;
			Vertices[vertexIndex++] = position[i][1].z;
			Vertices[vertexIndex++] = normals[i].x;
			Vertices[vertexIndex++] = normals[i].y;
			Vertices[vertexIndex++] = normals[i].z;
			Vertices[vertexIndex++] = uv2.x;
			Vertices[vertexIndex++] = uv2.y;
			Vertices[vertexIndex++] = tangent1.x;
			Vertices[vertexIndex++] = tangent1.y;
			Vertices[vertexIndex++] = tangent1.z;
			Vertices[vertexIndex++] = bitangent1.x;
			...
			// 顶点3
			Vertices[vertexIndex++] = position[i][2].x;
			Vertices[vertexIndex++] = position[i][2].y;
			Vertices[vertexIndex++] = position[i][2].z;
			Vertices[vertexIndex++] = normals[i].x;
			Vertices[vertexIndex++] = normals[i].y;
			Vertices[vertexIndex++] = normals[i].z;
			Vertices[vertexIndex++] = uv3.x;
			Vertices[vertexIndex++] = uv3.y;
			Vertices[vertexIndex++] = tangent1.x;
			Vertices[vertexIndex++] = tangent1.y;
			Vertices[vertexIndex++] = tangent1.z;
			Vertices[vertexIndex++] = bitangent1.x;
			...
			Vertices[vertexIndex++] = uv1.x;
			Vertices[vertexIndex++] = uv1.y;
			Vertices[vertexIndex++] = tangent2.x;
			Vertices[vertexIndex++] = tangent2.y;
			Vertices[vertexIndex++] = tangent2.z;
			Vertices[vertexIndex++] = bitangent2.x;
			Vertices[vertexIndex++] = bitangent2.y;
			Vertices[vertexIndex++] = bitangent2.z;
			...
			// 顶点4
			Vertices[vertexIndex++] = position[i][3].x;
			Vertices[vertexIndex++] = position[i][3].y;
			Vertices[vertexIndex++] = position[i][3].z;
			Vertices[vertexIndex++] = normals[i].x;
			Vertices[vertexIndex++] = normals[i].y;
			Vertices[vertexIndex++] = normals[i].z;
			Vertices[vertexIndex++] = uv4.x;
			Vertices[vertexIndex++] = uv4.y;
			Vertices[vertexIndex++] = tangent2.x;
			Vertices[vertexIndex++] = tangent2.y;
			Vertices[vertexIndex++] = tangent2.z;
			Vertices[vertexIndex++] = bitangent2.x;
...
//
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 9.5f, 80.0f));
		...
		wallShader.setBool("parallax", false);
		glActiveTexture(GL_TEXTURE0);
